<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProCategoryContent.aspx.cs" Inherits="BackStage_ProCategoryContent" %>
...
<article class="page-container">
	<form runat="server" class="form form-horizontal">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">项目类型名称：</label>
        ...
        <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">当前阶段：</label>
			<div class="formControls col-xs-8 col-sm-9"> 
