<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RecycleProject.aspx.cs" Inherits="BackStage_RecycleProject" %>
...
<div class="page-container">
	<div class="text-c">
	 ...
	 <span class="select-box inline">
        ...
        <asp:TextBox ID="txtName" runat="server" placeholder=" 项目名称" style="width:250px" class="input-text"></asp:TextBox>
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><asp:LinkButton ID="lbtDeleteMore" runat="server" class="btn btn-danger radius" OnClick="lbtDeleteMore_Click" OnClientClick="return confirm('确定删除?')"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</asp:LinkButton>
         <asp:LinkButton ID="lbtRecycle" runat="server" CssClass="btn btn-default radius" Text="批量恢复" OnClick="lbtRecycle_Click"></asp:LinkButton></span> <span class="r">共有数据：<strong><asp:Literal ID="ltSum" runat="server"></asp:Literal></strong> 条</span> </div>
        <div class="mt-20">
