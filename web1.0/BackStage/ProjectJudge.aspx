<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProjectJudge.aspx.cs" Inherits="BackStage_ProjectJudge" %>
...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 项目管理 <span class="c-gray en">&gt;</span> 项目审核 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
        <div class="mt-20">
		    <table class="table table-border table-bordered table-bg table-hover table-responsive">
			    <thead>
				    <tr class="text-c">
					    <th width="300">评审姓名</th>
                        <th width="200">备注</th>
					    <th width="80">是否通过</th>
				    </tr>
			    </thead>
            ...
            <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-primary radius" OnClick="btnSubmit_Click" Text="确认提交" style="margin-bottom:15px;" />	
</div>
<!--_footer 作为公共模版分离出去-->
