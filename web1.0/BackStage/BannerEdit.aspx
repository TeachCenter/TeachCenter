<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BannerEdit.aspx.cs" Inherits="BackStage_BannerEdit" %>
...
<article class="page-container">
	<form runat="server" class="form form-horizontal">
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<asp:TextBox ID="txtSummary" runat="server" CssClass="input-text" MaxLength="80"></asp:TextBox>
			</div>
		</div>
        <div class="row cl">
