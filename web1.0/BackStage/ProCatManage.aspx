<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProCatManage.aspx.cs" Inherits="BackStage_ProCatManage" %>
...
<title>项目类型分类管理</title>
</head>
<body><form id="form1" runat="server">
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>项目管理<span class="c-gray en">&gt;</span>项目类型分类管理<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
                ...
                <asp:Repeater ID="rptCategory" runat="server" OnItemDataBound="rptCategory_ItemDataBound" OnItemCommand="rptCategory_ItemCommand">
                    <ItemTemplate>
                        <tr class="text-c">
                            ...
                            <td><asp:Literal ID="ltName" runat="server" Text=<%# Eval("ProCatCategory_name") %>></asp:Literal></td>
					        <td class="f-14 td-manage"> 
                              <asp:LinkButton runat="server" CssClass="ml-5" CommandName="Editor" CommandArgument='<%# Eval("ProCatCategory_id") %>'><i class="Hui-iconfont">&#xe6df;</i></asp:LinkButton>
                              <asp:LinkButton runat="server" CssClass="text-decoration:none" CommandName="Delete" CommandArgument='<%#Eval("ProCatCategory_id") %>' OnClientClick="return confirm('确定删除?')"><i class="Hui-iconfont">&#xe6e2;</i></asp:LinkButton>
                            </td>
				        </tr>
                    </ItemTemplate>
                </asp:Repeater>
