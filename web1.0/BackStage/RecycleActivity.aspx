<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RecycleActivity.aspx.cs" Inherits="BackStage_RecycleActivity" %>
...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 活动信息管理 <span class="c-gray en">&gt;</span> 回收站--活动 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
                    ...
                    <ItemTemplate>
                        <tr class="text-c">
					        ...
					        <td class="f-14 td-manage">
                                ...
                                <asp:LinkButton runat="server" CssClass="text-decoration:none" CommandName="Delete" CommandArgument='<%#Eval("Activity_id") %>' OnClientClick="return confirm('确定彻底删除?')"><i class="Hui-iconfont">&#xe6e2;</i></asp:LinkButton>
                            </tr>
                    </ItemTemplate>
                </asp:Repeater>
			</tbody>
