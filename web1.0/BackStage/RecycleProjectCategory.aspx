<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RecycleProjectCategory.aspx.cs" Inherits="BackStage_RecycleProjectCategory" %>
...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
        <asp:LinkButton ID="lbtDeleteMore" runat="server" class="btn btn-danger radius" OnClick="lbtDeleteMore_Click" OnClientClick="return confirm('确定删除?')"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</asp:LinkButton> 
        <asp:LinkButton ID="lbtRecycle" runat="server" CssClass="btn btn-default radius" OnClick="lbtRecycle_Click">批量恢复</asp:LinkButton>
    </span> 
