...
<div class="page-container">
	<div class="text-c">
        ...
        <asp:TextBox ID="txtName" runat="server" placeholder=" 项目类型名称" style="width:250px" class="input-text" MaxLength="50"></asp:TextBox>
                    ...
                    <asp:Repeater ID="rptCategory" runat="server" OnItemCommand="rptCategory_ItemCommand">
                        <ItemTemplate>
				            <tr class="text-c">
					            ...
					            <td class="text-l"><u style="cursor:pointer" class="text-primary")" title="查看"><a href="ProCategoryContent.aspx?id=<%# Eval("id")%>" target="_blank"><%# Eval("name")%></a></u></td>	
