<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RecycleService.aspx.cs" Inherits="BackStage_RecycleService" %>
...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 回收站 <span class="c-gray en">&gt;</span> 服务列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
                    ...
                    <ItemTemplate>
                        <tr class="text-c">
                            ...
                            <td class="f-14 td-manage">
                                ...
                                <asp:LinkButton runat="server" CssClass="text-decoration:none" CommandName="Recycle" CommandArgument='<%#Eval("Service_id") %>' OnClientClick="return confirm('确定恢复?')">恢复</asp:LinkButton>
