<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EduSrcContent.aspx.cs" Inherits="BackStage_EduSrcContent" %>
...
<article class="page-container">
	<form runat="server" class="form form-horizontal">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> 
                <asp:Literal ID="lbPublisher" runat="server" ></asp:Literal> 
			</div>
		</div>
        <div class="row cl">
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> 
                <asp:Literal ID="lbViewTimes" runat="server" ></asp:Literal> 
			</div>
		</div>
        <div class="row cl">
