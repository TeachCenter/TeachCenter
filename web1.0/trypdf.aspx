<%@ Page Language="C#" AutoEventWireup="true" CodeFile="trypdf.aspx.cs" Inherits="trypdf" %>
		...
		<div class="main">
			<div class="center clearfix">
				<div class="left-content">
					...
					<a class="left-content-nav-content">期中学生反馈</a>
					<a class="left-content-nav-content">课件提升</a>
					<a class="left-content-nav-content">教学咨询</a>
				</div>
				<div class="right-content">
					<iframe class="pdf" src="pdfJs/generic/web/viewer.html" />?file=<c:url value="qaaa.pdf" />" width="100%" height="800"></iframe>
				</div>
			</div>
		</div>
		<div class="footer">
