    ...
    <div class="main clearfix">
			...
			<div class="teach ">
			 	<div class="teach-header clearfix">
			 		<h1>教学发展</h1>
			 		<a class="more" href="DevelopList.html?type=0&&page=1">MORE >></a>
			 	</div>
			...
			<div class="work">
				<div class="work-header clearfix">
			 		<h1>工作动态</h1>
			 		<a class="more" href="ActivitySummaryList.html?page=1">MORE >></a>
			 	</div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
	...
	$.ajax({ 
          ...
          success: function(data) {
          	...
          	{
          		topArr.push({"imgurl":data[0][i].Picture_path,href:"#"})
          		
          	}
          	$("#mySlide1").mySlide(topArr,3000);
          	for(i=0;i<data[1].length;i++)
          	{
          	    developArr.push({ "imgurl": data[1][i].Develop_path, "href": data[1][i].Develop_href == "" ? "DevelopContent.html?id=" + data[1][i].Develop_id : data[1][i].Develop_href, "text": data[1][i].Develop_title })
          		
          	}
          	$("#mySlide2").mySlide(developArr,3000);
          	for(i=0;i<data[2].length;i++)
          	{
          	    activityArr.push({ "imgurl": data[2][i].ActivitySummary_cover, "href": (data[2][i].ActivitySummary_href + data[2][i].ActivitySummary_id), "text": data[2][i].ActivitySummary_title })
